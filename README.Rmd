...
This is a basic example which shows you how to load the function an use dbSNP_info.
...
This is a basic example which shows you how to load the function an use snp_gene.
